      ...
      <div class="modal-content relative mx-auto w-full max-w-lg p-8">
        ...
        <div class="space-y-6">
              ...
              <div>
                ...
                <p class="text-sm font-semibold text-gray-800 dark:text-gray-200">
                  ...
                  <template v-if="apiKey.expirationMode === 'activation' && !apiKey.isActivated">
                    <i class="fas fa-pause-circle mr-1 text-primary-500" />
                    未激活
          ...
          <div v-if="apiKey.expirationMode === 'activation' && !apiKey.isActivated" class="mb-4">
            <button
              class="w-full rounded-lg bg-gradient-to-r from-primary-500 to-primary-600 px-4 py-3 font-semibold text-white transition-all hover:from-primary-600 hover:to-primary-700 hover:shadow-lg"
          ...
          <div
            ...
            class="rounded-lg border border-primary-200 bg-gradient-to-r from-primary-50 to-secondary-50 p-4 dark:border-primary-700 dark:from-primary-900/20 dark:to-secondary-900/20"
          >
            <div class="flex items-center justify-between">
              <div>
