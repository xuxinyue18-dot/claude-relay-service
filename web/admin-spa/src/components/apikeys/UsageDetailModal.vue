      ...
      >
        ...
        <div class="modal-scroll-content custom-scrollbar flex-1 overflow-y-auto">
          ...
          <div class="mb-6 grid grid-cols-1 gap-4 md:grid-cols-2">
            <!-- 请求统计卡片 -->
            <div
              class="rounded-lg border border-primary-200 bg-gradient-to-br from-primary-50 to-primary-100 p-4 dark:border-primary-700 dark:from-primary-900/20 dark:to-primary-800/20"
            >
              <div class="mb-3 flex items-center justify-between">
                <span class="text-sm font-medium text-gray-700 dark:text-gray-300">总请求数</span>
                <i class="fas fa-paper-plane text-primary-500" />
              </div>
            ...
            <!-- 平均统计卡片 -->
            <div
              class="rounded-lg border border-magenta-200 bg-gradient-to-br from-magenta-50 to-magenta-100 p-4 dark:border-magenta-700 dark:from-magenta-900/20 dark:to-magenta-800/20"
            >
              <div class="mb-3 flex items-center justify-between">
                <span class="text-sm font-medium text-gray-700 dark:text-gray-300">平均速率</span>
                <i class="fas fa-tachometer-alt text-magenta-500" />
              </div>
          ...
          <div class="mb-6">
            ...
            <div class="space-y-3 rounded-lg bg-gray-50 p-4 dark:bg-gray-700/50">
              ...
              <div class="flex items-center justify-between">
                <div class="flex items-center">
                  <i class="fas fa-arrow-up mr-2 text-primary-500" />
          ...
          <div v-if="hasLimits" class="mb-6">
            ...
            <div class="space-y-3 rounded-lg bg-gray-50 p-4 dark:bg-gray-700/50">
              ...
              <div
                ...
                class="flex items-center justify-between rounded-lg border border-magenta-200/70 bg-white/60 px-3 py-2 text-sm shadow-sm dark:border-magenta-500/40 dark:bg-magenta-950/20"
              >
                <span class="text-gray-600 dark:text-gray-300">并发限制</span>
                <span class="font-semibold text-magenta-600 dark:text-magenta-300">
              ...
              <div v-if="apiKey.rateLimitWindow > 0" class="space-y-2">
                <h5 class="text-sm font-medium text-gray-700 dark:text-gray-300">
                  <i class="fas fa-clock mr-1 text-primary-500" />
                  时间窗口限制
                </h5>
                <WindowCountdown
