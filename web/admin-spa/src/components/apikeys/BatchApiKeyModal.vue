    ...
    <div class="modal fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      >
        ...
        <div class="mb-6 grid grid-cols-2 gap-4 md:grid-cols-4">
          <div
            class="rounded-lg border border-primary-200 bg-gradient-to-br from-primary-50 to-primary-100 p-4"
          >
            <div class="flex items-center justify-between">
              <div>
                <p class="text-xs font-medium text-primary-600">创建数量</p>
                <p class="mt-1 text-2xl font-bold text-primary-900">
                  {{ apiKeys.length }}
                </p>
              </div>
              <div
                class="flex h-10 w-10 items-center justify-center rounded-lg bg-primary-500 bg-opacity-20"
              >
                <i class="fas fa-key text-primary-600" />
              </div>
            </div>
          </div>
          ...
          <div
            class="rounded-lg border border-magenta-200 bg-gradient-to-br from-magenta-50 to-magenta-100 p-4"
          >
            <div class="flex items-center justify-between">
              <div>
                <p class="text-xs font-medium text-magenta-600">权限范围</p>
                <p class="mt-1 text-lg font-bold text-magenta-900">
                  {{ getPermissionText() }}
                </p>
              </div>
              <div
                class="flex h-10 w-10 items-center justify-center rounded-lg bg-magenta-500 bg-opacity-20"
              >
                <i class="fas fa-shield-alt text-magenta-600" />
              </div>
            </div>
          </div>
        ...
        <div class="mb-6">
          <div class="mb-3 flex items-center justify-between">
            ...
            <div class="flex items-center gap-2">
              <button
                class="flex items-center gap-1 text-xs text-primary-600 hover:text-primary-800"
                type="button"
                @click="togglePreview"
              >
        ...
        <div class="mt-4 rounded-lg border border-primary-200 bg-primary-50 p-3">
          <p class="flex items-start text-xs text-primary-700">
