...
const containerClass = computed(() => {
  switch (props.type) {
    ...
    case 'opus':
      return 'border-secondary-200/80 bg-white/80 shadow-[0_10px_24px_rgb(var(--secondary-rgb)_/_0.18)] group-hover:shadow-[0_14px_30px_rgb(var(--secondary-rgb)_/_0.22)] dark:border-secondary-500/40 dark:bg-secondary-950/40 dark:shadow-[0_12px_28px_rgba(0,0,0,0.45)]'
    case 'window':
    ...
    case 'total':
      return 'border-primary-200/80 bg-white/80 shadow-[0_10px_24px_rgb(var(--primary-rgb)_/_0.18)] group-hover:shadow-[0_14px_30px_rgb(var(--primary-rgb)_/_0.22)] dark:border-primary-500/40 dark:bg-primary-950/40 dark:shadow-[0_12px_28px_rgba(0,0,0,0.45)]'
    default:
...
const backgroundClass = computed(() => {
  switch (props.type) {
    ...
    case 'opus':
      return 'bg-gradient-to-r from-secondary-50 via-secondary-100 to-magenta-100 dark:from-secondary-900/40 dark:via-secondary-900/20 dark:to-magenta-900/30'
    case 'window':
      return 'bg-gradient-to-r from-sky-50 via-sky-100 to-cyan-100 dark:from-sky-900/40 dark:via-sky-900/20 dark:to-cyan-900/30'
    case 'total':
      return 'bg-gradient-to-r from-primary-50 via-primary-100 to-accent-100 dark:from-primary-900/40 dark:via-primary-900/20 dark:to-accent-900/30'
    default:
...
const progressBarClass = computed(() => {
  ...
  if (props.type === 'opus') {
    if (p >= 90) {
      ...
      return 'bg-gradient-to-r from-secondary-400 via-secondary-500 to-magenta-500 dark:from-secondary-400 dark:via-secondary-500 dark:to-magenta-500'
    }
  }
  ...
  if (props.type === 'window') {
    if (p >= 90) {
      ...
      return 'bg-gradient-to-r from-accent-400 via-accent-400 to-primary-500 dark:from-accent-400 dark:via-accent-400 dark:to-primary-500'
    }
  }
  ...
  if (props.type === 'total') {
    if (p >= 90) {
      ...
      return 'bg-gradient-to-r from-primary-500 via-accent-500 to-primary-600 dark:from-primary-500 dark:via-accent-500 dark:to-primary-600'
    }
  }
  ...
  if (p >= 90) {
    ...
    switch (props.type) {
      case 'daily':
        ...
        break
      case 'opus':
        colorClass = 'text-secondary-700 dark:text-secondary-400'
        break
      case 'window':
        colorClass = 'text-accent-700 dark:text-accent-400'
        break
      case 'total':
...
const labelTextClass = computed(() => {
  ...
  if (p > 40) {
    ...
    switch (props.type) {
      ...
      case 'window':
        return 'text-accent-900 dark:text-accent-100'
      case 'total':
