        ...
        >
          ...
          <div class="rounded-lg bg-primary-50 p-4 dark:bg-primary-900/20">
            <div class="flex items-start gap-3">
              <i class="fas fa-info-circle mt-1 text-primary-500" />
              <div>
                ...
                <div v-if="form.tags.length > 0">
                  ...
                  <div class="flex flex-wrap gap-2">
                    <span
                      ...
                      :key="'selected-' + index"
                      class="inline-flex items-center gap-1 rounded-full bg-primary-100 px-3 py-1 text-sm text-primary-800 dark:bg-primary-900/30 dark:text-primary-300"
                    >
                      {{ tag }}
                      <button
                ...
                <div v-if="unselectedTags.length > 0">
                  ...
                  <div class="flex flex-wrap gap-2">
                    <button
                      ...
                      :key="'available-' + tag"
                      class="inline-flex items-center gap-1 rounded-full bg-gray-100 px-3 py-1 text-sm text-gray-700 transition-colors hover:bg-primary-100 hover:text-primary-700 dark:bg-gray-700 dark:text-gray-300 dark:hover:bg-primary-900/30 dark:hover:text-primary-300"
                      type="button"
                      @click="selectTag(tag)"
                    >
