        ...
        <div class="max-h-[70vh] overflow-y-auto px-5 py-4">
          ...
          <div class="mb-4 space-y-2">
            <div class="flex items-center justify-between text-sm">
              ...
              <span
                class="inline-flex items-center gap-1.5 rounded-full bg-primary-100 px-2.5 py-0.5 text-xs font-medium text-primary-700 dark:bg-primary-500/20 dark:text-primary-300"
              >
                <i class="fas fa-link" />
                /api/v1/messages
              </span>
            ...
            <div class="max-h-40 overflow-y-auto p-3">
              ...
              >
                ...
                <span
                  ...
                  class="inline-block h-4 w-1 animate-pulse bg-primary-500"
                />
              </p>
              <p
          ...
          <button
            :class="[
              ...
              testStatus === 'testing' || !apiKeyValue
                ...
                : 'bg-gradient-to-r from-primary-500 to-secondary-500 text-white hover:from-primary-600 hover:to-secondary-600 hover:shadow-md'
            ]"
...
const statusCardClass = computed(() => {
  switch (testStatus.value) {
    ...
    case 'testing':
      return 'border-primary-200 bg-primary-50 dark:border-primary-500/30 dark:bg-primary-900/20'
    case 'success':
...
const statusIconBgClass = computed(() => {
  switch (testStatus.value) {
    ...
    case 'testing':
      return 'bg-primary-100 dark:bg-primary-500/30'
    case 'success':
