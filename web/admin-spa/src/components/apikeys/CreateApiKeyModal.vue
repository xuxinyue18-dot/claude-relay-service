      ...
      <div class="modal-content mx-auto flex max-h-[90vh] w-full max-w-4xl flex-col p-4 sm:p-6">
        <div class="mb-4 flex items-center justify-between">
          <div class="flex items-center gap-2 sm:gap-3">
            <div
              class="flex h-8 w-8 items-center justify-center rounded-lg bg-gradient-to-br from-primary-500 to-secondary-600 sm:h-10 sm:w-10 sm:rounded-xl"
            >
        ...
        >
          <!-- 创建类型选择 -->
          <div
            class="rounded-lg border border-primary-200 bg-gradient-to-r from-primary-50 to-secondary-50 p-3 dark:border-primary-700 dark:from-primary-900/20 dark:to-secondary-900/20 sm:p-4"
          >
            <div
              :class="[
              ...
              <div class="flex items-center gap-3 sm:gap-4">
                <label class="flex cursor-pointer items-center">
                  <input
                    ...
                    class="mr-1.5 text-primary-600 focus:ring-primary-500 dark:border-gray-600 dark:bg-gray-700 sm:mr-2"
                    type="radio"
                    value="single"
                  />
                  <span
              ...
              <div v-if="form.tags.length > 0">
                ...
                <div class="flex flex-wrap gap-2">
                  <span
                    ...
                    :key="'selected-' + index"
                    class="inline-flex items-center gap-1 rounded-full bg-primary-100 px-3 py-1 text-sm text-primary-800 dark:bg-primary-900/30 dark:text-primary-400"
                  >
                    {{ tag }}
                    <button
              ...
              <div v-if="unselectedTags.length > 0">
                ...
                <div class="flex flex-wrap gap-2">
                  <button
                    ...
                    :key="'available-' + tag"
                    class="inline-flex items-center gap-1 rounded-full bg-gray-100 px-3 py-1 text-sm text-gray-700 transition-colors hover:bg-primary-100 hover:text-primary-700 dark:bg-gray-700 dark:text-gray-300 dark:hover:bg-primary-900/30 dark:hover:text-primary-400"
                    type="button"
                    @click="selectTag(tag)"
                  >
          ...
          <!-- 速率限制设置 -->
          <div
            class="rounded-lg border border-primary-200 bg-primary-50 p-3 dark:border-primary-700 dark:bg-primary-900/20"
          >
            <div class="mb-2 flex items-center gap-2">
              <div
                class="flex h-6 w-6 flex-shrink-0 items-center justify-center rounded bg-primary-500"
              >
            ...
            <div class="space-y-2">
              ...
              <div class="rounded-lg bg-primary-100 p-2 dark:bg-primary-900/30">
                <h5 class="mb-1 text-xs font-semibold text-primary-800 dark:text-primary-400">
                  💡 使用示例
                </h5>
                <div class="space-y-0.5 text-xs text-primary-700 dark:text-primary-300">
                  <div>
            ...
            <div class="flex flex-wrap gap-4">
              <label class="flex cursor-pointer items-center">
                <input
                  ...
                  class="mr-2 rounded text-primary-600 focus:ring-primary-500 dark:border-gray-600 dark:bg-gray-700"
                  type="checkbox"
                  value="claude"
                />
          ...
          <div>
            <div class="mb-2 flex items-center justify-between">
              ...
              >
              <button
                class="flex items-center gap-1 text-sm text-primary-600 transition-colors hover:text-primary-800 disabled:cursor-not-allowed disabled:opacity-50 dark:text-primary-400 dark:hover:text-primary-300"
          ...
          <div>
            <div class="mb-2 flex items-center">
              <input
                ...
                class="h-4 w-4 rounded border-gray-300 bg-gray-100 text-primary-600 focus:ring-primary-500"
                type="checkbox"
              />
              <label
                ...
                <div class="space-y-1">
                  <div v-for="client in supportedClients" :key="client.id" class="flex items-start">
                    <input
                      ...
                      class="mt-0.5 h-4 w-4 rounded border-gray-300 bg-gray-100 text-primary-600 focus:ring-primary-500"
                      type="checkbox"
                      :value="client.id"
                    />
