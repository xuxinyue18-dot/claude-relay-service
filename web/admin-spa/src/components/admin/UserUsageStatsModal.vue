      ...
      <div class="mt-3">
        ...
        <div v-else class="space-y-6">
          ...
          <div class="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-4">
            <div class="overflow-hidden rounded-lg bg-primary-50 shadow">
              <div class="p-5">
                <div class="flex items-center">
                  ...
                  <div class="ml-5 w-0 flex-1">
                    <dl>
                      <dt class="truncate text-sm font-medium text-primary-600">Requests</dt>
                      <dd class="text-lg font-medium text-primary-900">
            ...
            <div class="overflow-hidden rounded-lg bg-magenta-50 shadow">
              <div class="p-5">
                <div class="flex items-center">
                  <div class="flex-shrink-0">
                    <svg
                      class="h-6 w-6 text-magenta-600"
                      fill="none"
                      stroke="currentColor"
                      viewBox="0 0 24 24"
                    >
                  ...
                  <div class="ml-5 w-0 flex-1">
                    <dl>
                      <dt class="truncate text-sm font-medium text-magenta-600">Output Tokens</dt>
                      <dd class="text-lg font-medium text-magenta-900">
        ...
        <div class="mt-6 flex justify-end">
          <button
            class="rounded-md border border-gray-300 px-4 py-2 text-sm font-medium text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:ring-offset-2"
            @click="$emit('close')"
          >
            Close
          </button>
