          ...
          <div class="custom-scrollbar flex-1 overflow-y-auto">
            ...
            >
              <div
                ...
                :class="{ 'bg-primary-50 dark:bg-primary-900/20': modelValue === option.value }"
            ...
            <div
              class="cursor-pointer px-4 py-2 transition-colors hover:bg-gray-50 dark:hover:bg-gray-700"
              :class="{ 'bg-primary-50 dark:bg-primary-900/20': !modelValue }"
            ...
            <div v-if="filteredGroups.length > 0">
              ...
              <div
                ...
                class="cursor-pointer px-4 py-2 transition-colors hover:bg-gray-50 dark:hover:bg-gray-700"
                :class="{
                  'bg-primary-50 dark:bg-primary-900/20': modelValue === `group:${group.id}`
                }"
            ...
            <div v-if="filteredOAuthAccounts.length > 0">
              ...
              <div
                ...
                :key="account.id"
                class="cursor-pointer px-4 py-2 transition-colors hover:bg-gray-50 dark:hover:bg-gray-700"
                :class="{ 'bg-primary-50 dark:bg-primary-900/20': modelValue === account.id }"
            ...
            <div v-if="platform === 'claude' && filteredConsoleAccounts.length > 0">
              ...
              <div
                ...
                class="cursor-pointer px-4 py-2 transition-colors hover:bg-gray-50 dark:hover:bg-gray-700"
                :class="{
                  'bg-primary-50 dark:bg-primary-900/20': modelValue === `console:${account.id}`
                }"
            ...
            <div v-if="platform === 'openai' && filteredOpenAIResponsesAccounts.length > 0">
              ...
              <div
                ...
                class="cursor-pointer px-4 py-2 transition-colors hover:bg-gray-50 dark:hover:bg-gray-700"
                :class="{
                  'bg-primary-50 dark:bg-primary-900/20': modelValue === `responses:${account.id}`
                }"
            ...
            <div v-if="platform === 'gemini' && filteredGeminiApiAccounts.length > 0">
              ...
              <div
                ...
                class="cursor-pointer px-4 py-2 transition-colors hover:bg-gray-50 dark:hover:bg-gray-700"
                :class="{
                  'bg-primary-50 dark:bg-primary-900/20': modelValue === `api:${account.id}`
                }"
