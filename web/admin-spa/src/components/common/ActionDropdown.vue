...
const getActionClass = (action) => {
  const colorMap = {
    purple:
      'text-magenta-600 hover:bg-magenta-50 dark:text-magenta-400 dark:hover:bg-magenta-900/20',
    indigo:
      'text-secondary-600 hover:bg-secondary-50 dark:text-secondary-400 dark:hover:bg-secondary-900/20',
    blue: 'text-primary-600 hover:bg-primary-50 dark:text-primary-400 dark:hover:bg-primary-900/20',
