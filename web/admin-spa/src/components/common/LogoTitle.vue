<template>
  <div class="flex items-center gap-4">
    <!-- Logo区域 -->
    <div
      class="flex h-12 w-12 flex-shrink-0 items-center justify-center overflow-hidden rounded-xl border backdrop-blur-sm"
      :style="{
    ...
    >
      <template v-if="!loading">
        ...
        />
        <i v-else class="fas fa-cloud text-xl text-[color:var(--text-secondary)]" />
      </template>
