  ...
  <div class="flex h-full flex-col gap-4 md:gap-6">
    ...
    <div class="card flex h-full flex-col p-4 md:p-6">
      ...
      <div v-if="multiKeyMode && aggregatedStats" class="space-y-4">
        <!-- API Keys 概况 -->
        <div
          class="rounded-lg bg-gradient-to-r from-primary-50 to-secondary-50 p-4 dark:from-primary-900/20 dark:to-secondary-900/20"
        >
          <div class="mb-3 flex items-center justify-between">
            <span class="text-sm font-medium text-gray-700 dark:text-gray-300">
              <i class="fas fa-layer-group mr-2 text-primary-500" />
              API Keys 概况
            </span>
            <span
              class="rounded-full bg-primary-100 px-2 py-1 text-xs font-semibold text-primary-700 dark:bg-primary-800 dark:text-primary-200"
            >
        ...
        <!-- 聚合统计数据 -->
        <div
          class="rounded-lg bg-gradient-to-r from-magenta-50 to-magenta-100 p-4 dark:from-magenta-900/20 dark:to-magenta-900/30"
        >
          <div class="mb-3 flex items-center">
            <i class="fas fa-chart-pie mr-2 text-magenta-500" />
      ...
      <div v-if="!multiKeyMode" class="space-y-4 md:space-y-5">
        ...
        <div>
          ...
          <div v-else class="h-2 w-full rounded-full bg-gray-200">
            <div class="h-2 rounded-full bg-primary-500" style="width: 0%" />
          </div>
        </div>
        ...
        <div class="space-y-4 border-t border-gray-100 pt-3 dark:border-gray-700">
          ...
          <div class="space-y-2">
            ...
            <div
              ...
              class="flex flex-wrap gap-2 rounded-lg bg-primary-50 p-2 dark:bg-primary-900/20 md:p-3"
            >
              <span
                v-for="client in statsData.restrictions.allowedClients"
                :key="client"
                class="flex items-center gap-1 rounded-full bg-white px-2 py-1 text-xs text-primary-700 shadow-sm dark:bg-slate-900 dark:text-primary-300 md:text-sm"
              >
