    ...
    <div class="flex flex-col items-center justify-between gap-3 sm:flex-row sm:gap-4">
      ...
      <div class="flex items-center gap-2 sm:gap-4">
        ...
        <div class="user-menu-container relative">
          <button
            class="user-menu-button btn btn-primary flex items-center gap-2 rounded-2xl px-3 py-2 text-sm font-semibold text-white shadow-lg transition-all duration-200 hover:shadow-xl active:scale-95 sm:px-4 sm:py-2.5"
          ...
          >
              ...
              <div v-else class="mt-2 text-center">
                ...
                <transition mode="out-in" name="fade">
                  ...
                  <button
                    v-else
                    key="button"
                    class="text-xs text-primary-500 transition-colors hover:text-primary-700 dark:text-primary-400 dark:hover:text-primary-300"
            ...
            >
              <i class="fas fa-key text-primary-500" />
              <span>修改账户信息</span>
            </button>
