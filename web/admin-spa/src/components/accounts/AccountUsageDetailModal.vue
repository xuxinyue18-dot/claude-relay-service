      ...
      >
        ...
        >
          <div class="flex flex-1 items-start gap-3">
            <div
              class="flex h-12 w-12 flex-shrink-0 items-center justify-center rounded-xl bg-gradient-to-br from-primary-500 to-secondary-500 text-white shadow-lg"
            >
            ...
            <div class="space-y-1">
              <div class="flex flex-wrap items-center gap-2">
                ...
                <Badge v-if="account?.platform" variant="primary">
                  <i class="fas fa-layer-group" />{{ platformLabel }}
                </Badge>
                <Badge v-if="account?.accountType" variant="magenta">
                  <i class="fas fa-user-tag" />{{ accountTypeLabel }}
                </Badge>
              </div>
          ...
          <div class="flex items-center gap-2">
            <button
              class="flex items-center gap-2 rounded-full bg-magenta-100 px-3 py-2 text-xs font-semibold text-magenta-700 transition hover:bg-magenta-200 dark:bg-magenta-500/10 dark:text-magenta-200 dark:hover:bg-magenta-500/20"
              @click="goTimeline"
            >
        ...
        <div class="flex-1 overflow-y-auto px-5 py-4 sm:px-6">
          <div v-if="loading" class="flex h-[50vh] items-center justify-center">
            <div class="loading-spinner h-12 w-12 border-4 border-primary-500" />
          </div>
          <template v-else>
            <!-- 关键指标 -->
            ...
            <div class="mb-6 grid grid-cols-1 gap-4 lg:grid-cols-3">
              <div
                class="space-y-3 rounded-2xl border border-primary-100 bg-primary-50/60 p-4 dark:border-primary-500/20 dark:bg-primary-900/20"
              >
                <div
                  class="flex items-center gap-2 text-sm font-semibold text-primary-700 dark:text-primary-300"
                >
                  <i class="fas fa-sun" />
                  今日概览
                </div>
                <div
                  class="rounded-xl bg-white/80 p-3 text-sm text-gray-600 shadow-sm ring-1 ring-primary-100 dark:bg-gray-900/80 dark:text-gray-300 dark:ring-primary-500/20"
                >
            ...
            <div class="mb-6 grid grid-cols-1 gap-4 lg:grid-cols-3">
              ...
              >
                ...
                >
                  <i class="fas fa-database mr-2 text-secondary-500" /> 累计 Token
                </h4>
              ...
              >
                <h4
                  class="mb-3 flex items-center text-sm font-semibold text-gray-700 dark:text-gray-300"
                >
                  <i class="fas fa-tachometer-alt mr-2 text-magenta-500" /> 平均速率
                </h4>
                <div class="space-y-2 text-sm text-gray-600 dark:text-gray-300">
                  <div class="flex items-center justify-between">
                    <span>RPM</span>
            ...
            >
              <div class="mb-4 flex flex-wrap items-center justify-between gap-2">
                ...
                >
                  <i class="fas fa-chart-line mr-2 text-primary-500" /> 30天费用与请求趋势
                </h4>
