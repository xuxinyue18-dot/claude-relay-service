  ...
  <div class="min-w-[200px] space-y-1">
    ...
    <div v-else-if="balanceData" class="space-y-1">
      ...
      <div class="flex items-center justify-between gap-2">
        ...
        <button
          v-if="!hideRefresh"
          class="text-xs text-gray-500 hover:text-primary-600 disabled:cursor-not-allowed disabled:opacity-40 dark:text-gray-400 dark:hover:text-primary-400"
      ...
      <div v-else-if="balanceData.quota?.unlimited" class="flex items-center gap-2">
        <i class="fas fa-infinity text-primary-500 dark:text-primary-400"></i>
...
const antigravityRows = computed(() => {
  ...
  const styles = {
    'Gemini Pro': { dotClass: 'bg-primary-500', barClass: 'bg-primary-500 dark:bg-primary-400' },
    Claude: { dotClass: 'bg-secondary-500', barClass: 'bg-secondary-500 dark:bg-secondary-400' },
    'Gemini Flash': { dotClass: 'bg-accent-500', barClass: 'bg-accent-500 dark:bg-accent-400' },
