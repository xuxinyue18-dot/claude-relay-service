    ...
    <div v-if="show" class="modal fixed inset-0 z-50 flex items-center justify-center p-3 sm:p-4">
      ...
      >
          ...
          <div class="flex items-center space-x-2 sm:space-x-4">
            <div class="flex items-center">
              <div
                :class="[
                  ...
                  oauthStep >= 1 ? 'bg-primary-500 text-white' : 'bg-gray-200 text-gray-500'
                ]"
              >
                1
              </div>
            ...
            <div class="flex items-center">
              <div
                :class="[
                  'flex h-6 w-6 items-center justify-center rounded-full text-xs font-semibold sm:h-8 sm:w-8 sm:text-sm',
                  oauthStep >= 2 ? 'bg-primary-500 text-white' : 'bg-gray-200 text-gray-500'
                ]"
              >
                2
              </div>
          ...
          <div class="space-y-6">
                ...
                <div class="grid grid-cols-2 gap-2 sm:grid-cols-4">
                  ...
                  <div
                    ...
                    :class="[
                      platformGroup === 'claude'
                        ? 'border-secondary-500 bg-gradient-to-br from-secondary-50 to-magenta-50 shadow-md dark:from-secondary-900/20 dark:to-magenta-900/20'
                        : 'border-gray-200 bg-white hover:border-secondary-300 hover:shadow dark:border-gray-700 dark:bg-gray-800 dark:hover:border-secondary-600'
                    ]"
                  ...
                  >
                    <div class="p-3">
                      <div class="flex items-center justify-between">
                        <div
                          class="flex h-8 w-8 items-center justify-center rounded-md bg-gradient-to-br from-secondary-500 to-magenta-600"
                        >
                          <i class="fas fa-brain text-sm text-white"></i>
                        </div>
                        <div
                          v-if="platformGroup === 'claude'"
                          class="flex h-5 w-5 items-center justify-center rounded-full bg-secondary-500"
                        >
                  ...
                  <div
                    ...
                    :class="[
                      platformGroup === 'gemini'
                        ? 'border-primary-500 bg-gradient-to-br from-primary-50 to-secondary-50 shadow-md dark:from-primary-900/20 dark:to-secondary-900/20'
                        : 'border-gray-200 bg-white hover:border-primary-300 hover:shadow dark:border-gray-700 dark:bg-gray-800 dark:hover:border-primary-600'
                    ]"
                  ...
                  >
                    <div class="p-3">
                      <div class="flex items-center justify-between">
                        <div
                          class="flex h-8 w-8 items-center justify-center rounded-md bg-gradient-to-br from-primary-500 to-secondary-600"
                        >
                  ...
                  <div class="grid grid-cols-2 gap-2 sm:grid-cols-3">
                      ...
                      <label
                        ...
                        :class="[
                          form.platform === 'claude'
                            ? 'border-secondary-500 bg-secondary-50 dark:border-secondary-400 dark:bg-secondary-900/30'
                            : 'border-gray-300 bg-white hover:border-secondary-400 hover:bg-secondary-50/50 dark:border-gray-600 dark:bg-gray-700 dark:hover:border-secondary-500 dark:hover:bg-secondary-900/20'
                        ]"
                      >
                        <input
                        ...
                        <div class="flex items-center gap-2">
                          <i
                            class="fas fa-brain text-sm text-secondary-600 dark:text-secondary-400"
                          ></i>
                          <div>
                        ...
                        <div
                          ...
                          class="absolute right-1 top-1 flex h-4 w-4 items-center justify-center rounded-full bg-secondary-500"
                        >
                          <i class="fas fa-check text-xs text-white"></i>
                        </div>
                      </label>
                      ...
                      <label
                        ...
                        :class="[
                          form.platform === 'claude-console'
                            ? 'border-magenta-500 bg-magenta-50 dark:border-magenta-400 dark:bg-magenta-900/30'
                            : 'border-gray-300 bg-white hover:border-magenta-400 hover:bg-magenta-50/50 dark:border-gray-600 dark:bg-gray-700 dark:hover:border-magenta-500 dark:hover:bg-magenta-900/20'
                        ]"
                      >
                        <input
                          v-model="form.platform"
                        ...
                        <div class="flex items-center gap-2">
                          <i
                            class="fas fa-terminal text-sm text-magenta-600 dark:text-magenta-400"
                          ></i>
                          <div>
                            <span class="block text-xs font-medium text-gray-900 dark:text-gray-100"
                              >Claude Console</span
                        ...
                        <div
                          ...
                          class="absolute right-1 top-1 flex h-4 w-4 items-center justify-center rounded-full bg-magenta-500"
                        >
                          <i class="fas fa-check text-xs text-white"></i>
                        </div>
                      </label>
                      ...
                      <label
                        ...
                        :class="[
                          form.platform === 'azure_openai'
                            ...
                            : 'border-gray-300 bg-white hover:border-primary-400 hover:bg-primary-50/50 dark:border-gray-600 dark:bg-gray-700 dark:hover:border-primary-500 dark:hover:bg-primary-900/20'
                        ]"
                      >
                        <input
                          v-model="form.platform"
                        ...
                        <div class="flex items-center gap-2">
                          <i
                            class="fab fa-microsoft text-sm text-primary-600 dark:text-primary-400"
                          ></i>
                          <div>
                            <span class="block text-xs font-medium text-gray-900 dark:text-gray-100"
                              >Azure</span
                        ...
                        <div
                          ...
                          class="absolute right-1 top-1 flex h-4 w-4 items-center justify-center rounded-full bg-primary-500"
                        >
                          <i class="fas fa-check text-xs text-white"></i>
                        </div>
                      </label>
                    ...
                    <template v-if="platformGroup === 'gemini'">
                      ...
                      >
                        ...
                        <div class="flex items-center gap-2">
                          <i
                            class="fab fa-google text-sm text-primary-600 dark:text-primary-400"
                          ></i>
                          <div>
                            <span class="block text-xs font-medium text-gray-900 dark:text-gray-100"
                              >Gemini Cli</span
                      ...
                      >
                        ...
                        <div class="flex items-center gap-2">
                          <i
                            class="fas fa-rocket text-sm text-magenta-600 dark:text-magenta-400"
                          ></i>
                          <div>
                            <span class="block text-xs font-medium text-gray-900 dark:text-gray-100"
                              >Antigravity</span
              ...
              <div class="flex flex-wrap gap-4">
                <label class="flex cursor-pointer items-center">
                  <input
                    ...
                    class="mr-2 text-primary-600 focus:ring-primary-500 dark:border-gray-600 dark:bg-gray-700"
                    type="radio"
                    value="oauth"
                  />
            ...
            <div v-if="form.accountType === 'group'">
              ...
              <div class="flex gap-2">
                <div class="flex-1">
                  ...
                  >
                    ...
                    <div class="border-t pt-2 dark:border-gray-600">
                      <button
                        class="flex items-center gap-2 text-sm text-primary-600 hover:text-primary-800 dark:text-primary-400 dark:hover:text-primary-300"
                        type="button"
                ...
                <button
                  class="rounded-md border border-gray-300 bg-white px-3 py-2 text-sm font-medium text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:ring-offset-2 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-200 dark:hover:bg-gray-600"
                  type="button"
                  @click="refreshGroups"
                >
            ...
            <div v-if="form.platform === 'bedrock'" class="space-y-4">
              ...
              <div>
                ...
                <div
                  class="mt-2 rounded-lg border border-primary-200 bg-primary-50 p-3 dark:border-primary-700 dark:bg-primary-900/30"
                >
                  <div class="flex items-start gap-2">
                    <i class="fas fa-info-circle mt-0.5 text-primary-600 dark:text-primary-400" />
                ...
                <div class="mb-3">
                  <label class="inline-flex cursor-pointer items-center">
                    <input
                      ...
                      class="mr-2 rounded border-gray-300 text-primary-600 focus:border-primary-500 focus:ring focus:ring-primary-200 dark:border-gray-600 dark:bg-gray-700"
                      type="checkbox"
                    />
            ...
            >
              ...
              <div>
                  ...
                  <button
                    ...
                    :class="
                      modelRestrictionMode === 'whitelist'
                        ...
                        : 'border border-gray-300 text-gray-600 hover:border-primary-300 dark:border-gray-600 dark:text-gray-400 dark:hover:border-primary-500'
                    "
                    type="button"
                  ...
                  <button
                    ...
                    :class="
                      modelRestrictionMode === 'mapping'
                        ...
                        : 'border border-gray-300 text-gray-600 hover:border-magenta-300 dark:border-gray-600 dark:text-gray-400 dark:hover:border-magenta-500'
                    "
                    type="button"
                ...
                <div v-if="modelRestrictionMode === 'whitelist'">
                  <div class="mb-3 rounded-lg bg-primary-50 p-3 dark:bg-primary-900/30">
                ...
                <!-- 映射模式 -->
                <div v-else>
                  <div class="mb-3 rounded-lg bg-magenta-50 p-3 dark:bg-magenta-900/30">
                    <p class="text-xs text-magenta-700 dark:text-magenta-400">
                      <i class="fas fa-info-circle mr-1" />
                  ...
                  <div class="mt-3 flex flex-wrap gap-2">
                    <button
                      class="rounded-lg bg-primary-100 px-3 py-1 text-xs text-primary-700 transition-colors hover:bg-primary-200 dark:bg-primary-900/30 dark:text-primary-400 dark:hover:bg-primary-900/50"
                      type="button"
                      @click="
                    ...
                    <button
                      class="rounded-lg bg-secondary-100 px-3 py-1 text-xs text-secondary-700 transition-colors hover:bg-secondary-200 dark:bg-secondary-900/30 dark:text-secondary-400 dark:hover:bg-secondary-900/50"
                      type="button"
                      @click="
            ...
            <div v-if="form.platform === 'claude'" class="mt-4">
              <label class="flex items-start">
                <input
                  ...
                  class="mt-1 text-primary-600 focus:ring-primary-500 dark:border-gray-600 dark:bg-gray-700"
                  type="checkbox"
                />
                <div class="ml-3">
                  <span class="text-sm font-medium text-gray-700 dark:text-gray-300">
                  ...
                  <div v-if="form.useUnifiedClientId" class="mt-3">
                    ...
                    >
                      <div class="mb-2 flex items-center justify-between">
                        ...
                        >
                        <button
                          class="rounded-md bg-primary-100 px-2.5 py-1 text-xs font-medium text-primary-700 transition-colors hover:bg-primary-200 dark:bg-primary-900/30 dark:text-primary-400 dark:hover:bg-primary-900/50"
                          type="button"
                      ...
                      <p class="mt-2 text-xs text-gray-500 dark:text-gray-400">
                        <i class="fas fa-info-circle mr-1 text-primary-500" />
            ...
            <div
              v-if="
                ...
                form.platform !== 'openai-responses'
              "
              class="space-y-4 rounded-lg border border-primary-200 bg-primary-50 p-4"
            >
              <div class="mb-4 flex items-start gap-3">
                <div
                  class="mt-1 flex h-8 w-8 flex-shrink-0 items-center justify-center rounded-lg bg-primary-500"
                >
                  <i class="fas fa-info text-sm text-white" />
                </div>
                <div>
                  <h5 class="mb-2 font-semibold text-primary-900 dark:text-primary-300">
                    手动输入 Token
                  </h5>
                  <p
                    v-if="form.platform === 'claude'"
                    class="mb-2 text-sm text-primary-800 dark:text-primary-300"
                  >
                  ...
                  <div
                    class="mb-2 mt-2 rounded-lg border border-primary-300 bg-white/80 p-3 dark:border-primary-600 dark:bg-gray-800/80"
                  >
                    <p class="mb-1 text-sm font-medium text-primary-900 dark:text-primary-300">
                      <i class="fas fa-folder-open mr-1" />
                      获取 Access Token 的方法：
                    </p>
                    <p
                      v-if="form.platform === 'claude'"
                      class="text-xs text-primary-800 dark:text-primary-300"
                    >
                      请从已登录 Claude Code 的机器上获取
                      <code
                        class="rounded bg-primary-100 px-1 py-0.5 font-mono dark:bg-primary-900/50"
            ...
            <div
              ...
              class="space-y-4 rounded-lg border border-magenta-200 bg-magenta-50 p-4 dark:border-magenta-700 dark:bg-magenta-900/30"
            >
              <div class="mb-4 flex items-start gap-3">
                <div
                  class="mt-1 flex h-8 w-8 flex-shrink-0 items-center justify-center rounded-lg bg-magenta-500"
                >
                  <i class="fas fa-key text-sm text-white" />
                </div>
                <div>
                  <h5 class="mb-2 font-semibold text-magenta-900 dark:text-magenta-200">
                    使用 API Key 调度 Droid
                  </h5>
                  <p class="text-sm text-magenta-800 dark:text-magenta-200">
              ...
              <div
                class="rounded-lg border border-magenta-200 bg-white/70 p-3 text-xs text-magenta-800 dark:border-magenta-700 dark:bg-magenta-800/20 dark:text-magenta-100"
              >
        ...
        <div v-if="oauthStep === 2 && form.addType === 'setup-token'" class="space-y-6">
          ...
          <div v-if="form.platform === 'claude'">
            <div
              class="rounded-lg border border-primary-200 bg-primary-50 p-6 dark:border-primary-700 dark:bg-primary-900/30"
            >
              <div class="flex items-start gap-4">
                <div
                  class="flex h-10 w-10 flex-shrink-0 items-center justify-center rounded-lg bg-primary-500"
                >
                  <i class="fas fa-key text-white" />
                </div>
                <div class="flex-1">
                  <h4 class="mb-3 font-semibold text-primary-900 dark:text-primary-200">
                    Claude Setup Token 授权
                  </h4>

                  <!-- 授权方式选择 -->
                  <div class="mb-4">
                    <p class="mb-3 text-sm font-medium text-primary-800 dark:text-primary-300">
                      选择授权方式：
                    </p>
                    <div class="flex flex-wrap gap-4">
                      <label class="flex cursor-pointer items-center">
                        ...
                        />
                        <span class="text-sm text-primary-800 dark:text-primary-300">
                  ...
                  <div v-if="authMethod === 'manual'" class="space-y-4">
                    ...
                    <!-- 步骤1: 生成授权链接 -->
                    <div
                      class="rounded-lg border border-primary-300 bg-white/80 p-4 dark:border-primary-600 dark:bg-gray-800/80"
                    >
                    ...
                    >
                      <div class="flex items-start gap-3">
                        ...
                        <div class="flex-1">
                          ...
                          <p class="mb-2 text-sm text-primary-700 dark:text-primary-300">
                        ...
                        <div class="flex-1">
                          ...
                          <div class="space-y-3">
                            <div>
                              ...
                              >
                                <i class="fas fa-key mr-2 text-primary-500" />Authorization Code
                              </label>
                              <textarea
                    ...
                    >
                      <div class="space-y-4">
                        <div>
                          ...
                          >
                            <i class="fas fa-cookie text-primary-500" />sessionKey
                            <span
                        ...
                        <div>
                          <button
                            class="flex items-center text-xs text-primary-600 hover:text-primary-700"
                            type="button"
        ...
        <div v-if="isEdit" class="space-y-6">
            ...
            <div>
              ...
              <div v-else>
                ...
                <div class="mt-3 flex flex-wrap gap-2">
                  ...
                  <button
                    class="rounded-lg bg-magenta-100 px-3 py-1 text-xs text-magenta-700 transition-colors hover:bg-magenta-200 dark:bg-magenta-900/30 dark:text-magenta-400 dark:hover:bg-magenta-900/50"
                    type="button"
                    @click="
            ...
            <div>
              ...
              <div class="mb-3">
                <label class="inline-flex cursor-pointer items-center">
                  <input
                    v-model="form.enableRateLimit"
                    class="mr-2 rounded border-gray-300 text-primary-600 focus:border-primary-500 focus:ring focus:ring-primary-200"
                    type="checkbox"
                  />
          ...
          <div v-if="form.platform === 'bedrock'" class="space-y-4">
            ...
            <div>
              ...
              <div class="mt-2 rounded-lg border border-primary-200 bg-primary-50 p-3">
                <div class="flex items-start gap-2">
                  <i class="fas fa-info-circle mt-0.5 text-primary-600" />
          ...
          <div
            ...
            class="rounded-lg border border-magenta-200 bg-magenta-50 p-4 dark:border-magenta-700 dark:bg-magenta-900/30"
          >
            <div class="mb-4 flex items-start gap-3">
              <div
                class="mt-1 flex h-8 w-8 flex-shrink-0 items-center justify-center rounded-lg bg-magenta-500"
              ...
              <div class="flex-1">
                <div class="mb-2 flex items-center justify-between">
                  <h5 class="font-semibold text-magenta-900 dark:text-magenta-200">更新 API Key</h5>
                  <button
                    class="flex items-center gap-1.5 rounded-lg bg-magenta-600 px-3 py-1.5 text-xs font-medium text-white transition-colors hover:bg-magenta-700 dark:bg-magenta-500 dark:hover:bg-magenta-600"
                    type="button"
                ...
                <p class="mb-1 text-sm text-magenta-800 dark:text-magenta-200">
                  当前已保存 <strong>{{ existingApiKeyCount }}</strong> 条 API Key。您可以追加新的
                  Key，或通过下方模式快速覆盖、删除指定 Key。
                </p>
                <p class="text-xs text-magenta-700 dark:text-magenta-300">
            ...
            <div class="space-y-4">
              ...
              <div class="space-y-2">
                <div class="flex items-center justify-between">
                  <span class="text-sm font-semibold text-magenta-800 dark:text-magenta-100"
                    >API Key 更新模式</span
                  >
                  <span class="text-xs text-magenta-600 dark:text-magenta-300">
                    {{ currentApiKeyModeLabel }}
                  </span>
                </div>
                <div
                  class="relative grid h-11 grid-cols-3 overflow-hidden rounded-2xl border border-magenta-200/80 bg-gradient-to-r from-magenta-50/80 via-white to-magenta-50/80 shadow-inner dark:border-magenta-700/70 dark:from-magenta-900/40 dark:via-magenta-900/20 dark:to-magenta-900/40"
                >
                  <span
                    class="pointer-events-none absolute inset-y-0 rounded-2xl bg-gradient-to-r from-magenta-500/90 via-magenta-600 to-secondary-500/90 shadow-lg ring-1 ring-magenta-100/80 transition-all duration-300 ease-out dark:from-magenta-500/70 dark:via-magenta-600/70 dark:to-secondary-500/70 dark:ring-magenta-400/30"
                    :style="apiKeyModeSliderStyle"
                  />
                  <button
                    v-for="option in apiKeyModeOptions"
                    :key="option.value"
                    class="relative z-10 flex items-center justify-center rounded-2xl px-2 text-xs font-semibold transition-all duration-200 ease-out focus:outline-none focus-visible:ring-2 focus-visible:ring-magenta-500/60 dark:focus-visible:ring-magenta-400/60"
                    :class="
                      form.apiKeyUpdateMode === option.value
                        ? 'text-white drop-shadow-sm'
                        : 'text-magenta-500/80 hover:text-magenta-700 dark:text-magenta-200/70 dark:hover:text-magenta-100'
                    "
                    type="button"
