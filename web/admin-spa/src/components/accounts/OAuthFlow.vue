            ...
            <div class="mb-4">
              ...
              <div class="flex gap-4">
                <label class="flex cursor-pointer items-center gap-2">
                  ...
                  />
                  <span class="text-sm text-primary-900 dark:text-primary-200">手动授权</span>
                </label>
                <label class="flex cursor-pointer items-center gap-2">
                  <input
                    v-model="authMethod"
                    ...
                    @change="onAuthMethodChange"
                  />
                  <span class="text-sm text-primary-900 dark:text-primary-200">Cookie自动授权</span>
                </label>
              </div>
            </div>
            ...
            <div v-if="authMethod === 'cookie'" class="space-y-4">
              ...
              >
                ...
                <div class="mb-4">
                  ...
                  >
                    <i class="fas fa-cookie text-primary-500" />
                    sessionKey
                    <span
                ...
                <div class="flex items-start gap-3">
                  ...
                  <div class="flex-1">
                    ...
                    <div class="space-y-3">
                      ...
                      <div
                        class="rounded border border-primary-300 bg-primary-50 p-2 dark:border-primary-700 dark:bg-primary-900/30"
                      >
