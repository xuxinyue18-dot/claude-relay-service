          ...
          <div class="mb-4 border-b border-gray-200 pb-4 dark:border-gray-700 md:mb-6 md:pb-6">
            ...
            >
              <div class="flex items-center gap-2 md:gap-3">
                <i class="fas fa-clock text-base text-primary-500 md:text-lg" />
...
.gradient-bg::before {
  ...
  bottom: 0;
  background:
    radial-gradient(circle at 20% 80%, rgba(255, 43, 214, 0.16) 0%, transparent 52%),
    radial-gradient(circle at 80% 20%, rgba(0, 229, 255, 0.14) 0%, transparent 52%),
    radial-gradient(circle at 45% 45%, rgba(168, 85, 247, 0.12) 0%, transparent 55%);
  pointer-events: none;
  z-index: 0;
}
...
.gradient-bg-dark::before {
  ...
  background:
    repeating-linear-gradient(
      to bottom,
      rgba(232, 241, 255, 0.035) 0px,
      rgba(232, 241, 255, 0.035) 1px,
      transparent 2px,
      transparent 7px
    ),
    radial-gradient(circle at 20% 80%, rgba(255, 43, 214, 0.12) 0%, transparent 55%),
    radial-gradient(circle at 80% 20%, rgba(0, 229, 255, 0.12) 0%, transparent 55%),
    radial-gradient(circle at 45% 45%, rgba(168, 85, 247, 0.1) 0%, transparent 60%);
  pointer-events: none;
  z-index: 0;
}
...
.period-btn.active {
  ...
  color: white;
  box-shadow:
    0 10px 15px -3px var(--shadow-primary-strong),
    0 4px 6px -2px var(--shadow-primary-soft);
