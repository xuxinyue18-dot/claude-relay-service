  ...
  <div class="space-y-4 p-4 lg:p-6">
    <div class="flex flex-wrap items-center justify-between gap-3">
      ...
      <div class="flex items-center gap-2 text-sm text-gray-500 dark:text-gray-400">
        <i class="fas fa-clock text-primary-500" />
            ...
            <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-800">
              ...
              >
                <tr v-for="record in records" :key="record.timestamp + record.model">
                  ...
                  <td
                    class="whitespace-nowrap px-4 py-3 text-sm text-primary-600 dark:text-primary-400"
                  >
                  ...
                  <td
                    class="whitespace-nowrap px-4 py-3 text-sm text-magenta-600 dark:text-magenta-400"
                  >
