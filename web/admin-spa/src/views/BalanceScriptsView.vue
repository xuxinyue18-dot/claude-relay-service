  ...
  <div class="space-y-6">
      ...
      <div class="glass-strong flex-1 rounded-2xl p-4 shadow-lg">
        <div class="mb-3 flex items-center justify-between">
          ...
          <div class="flex gap-2">
            ...
            <button
              class="rounded-lg bg-gradient-to-r from-primary-600 to-secondary-600 px-4 py-2 text-sm font-semibold text-white transition hover:from-primary-700 hover:to-secondary-700 disabled:cursor-not-allowed disabled:opacity-60"
              :disabled="saving"
              @click="saveConfig"
            >
    ...
    <div class="glass-strong rounded-2xl p-4 shadow-lg">
      ...
      <textarea
        ...
        class="min-h-[320px] w-full rounded-xl bg-gray-900 font-mono text-sm text-gray-100 shadow-inner focus:outline-none focus:ring-2 focus:ring-primary-500"
        spellcheck="false"
      ></textarea>
...
<style scoped>
.input-text {
  @apply w-full rounded-lg border border-gray-200 bg-white px-3 py-2 text-sm text-gray-800 shadow-sm transition focus:border-primary-400 focus:outline-none focus:ring-2 focus:ring-primary-200 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-100 dark:focus:border-primary-500 dark:focus:ring-primary-600;
}
</style>
