<template>
              ...
              <tbody class="divide-y divide-gray-200/50 dark:divide-gray-600/50">
                ...
                <tr class="table-row">
                  <td class="w-48 whitespace-nowrap px-6 py-4">
                    <div class="flex items-center">
                      <div
                        class="mr-3 flex h-8 w-8 items-center justify-center rounded-lg bg-gradient-to-br from-primary-500 to-primary-600"
                      >
                ...
                <tr class="table-row">
                  <td class="w-48 whitespace-nowrap px-6 py-4">
                    <div class="flex items-center">
                      <div
                        class="mr-3 flex h-8 w-8 items-center justify-center rounded-lg bg-gradient-to-br from-magenta-500 to-magenta-600"
                      >
                ...
                <tr class="table-row">
                  <td class="w-48 whitespace-nowrap px-6 py-4">
                    <div class="flex items-center">
                      <div
                        class="mr-3 flex h-8 w-8 items-center justify-center rounded-lg bg-gradient-to-br from-secondary-500 to-magenta-600"
                      >
          ...
          <div class="space-y-4 sm:hidden">
            ...
            <div class="glass-card p-4">
              <div class="mb-3 flex items-center gap-3">
                <div
                  class="flex h-10 w-10 flex-shrink-0 items-center justify-center rounded-xl bg-gradient-to-br from-primary-500 to-accent-600 text-white shadow-md"
                >
            ...
            <div class="glass-card p-4">
              <div class="mb-3 flex items-center gap-3">
                <div
                  class="flex h-10 w-10 flex-shrink-0 items-center justify-center rounded-xl bg-gradient-to-br from-magenta-500 to-magenta-600 text-white shadow-md"
                >
            ...
            <div class="glass-card p-4">
              <div class="mb-3 flex items-center gap-3">
                <div
                  class="flex h-10 w-10 flex-shrink-0 items-center justify-center rounded-xl bg-gradient-to-br from-secondary-500 to-magenta-600 text-white shadow-md"
                >
              ...
              >
                <div class="flex items-start justify-between">
                  ...
                  <div class="ml-4 flex items-center space-x-2">
                    ...
                    <!-- 测试按钮 -->
                    <button
                      class="rounded-lg bg-primary-100 p-2 text-primary-600 transition-colors hover:bg-primary-200 dark:bg-primary-900 dark:text-primary-400 dark:hover:bg-primary-800"
                      title="测试连接"
          ...
          <div v-else>
            ...
            >
              <div class="flex items-center justify-between">
                <div>
                  <div class="flex items-center">
                    <div
                      class="mr-3 flex h-10 w-10 items-center justify-center rounded-full bg-gradient-to-br from-magenta-500 to-secondary-600 text-white shadow-lg"
                    >
                ...
                <label class="relative inline-flex cursor-pointer items-center">
                  ...
                  />
                  <div
                    class="peer h-6 w-11 rounded-full bg-gray-200 after:absolute after:left-[2px] after:top-[2px] after:h-5 after:w-5 after:rounded-full after:border after:border-gray-300 after:bg-white after:transition-all after:content-[''] peer-checked:bg-magenta-500 peer-checked:after:translate-x-full peer-checked:after:border-white peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-magenta-300 dark:border-gray-600 dark:bg-gray-700 dark:peer-focus:ring-magenta-800"
                  ></div>
                </label>
              </div>
              ...
              <div v-if="claudeConfig.globalSessionBindingEnabled" class="mt-6 space-y-4">
                ...
                <div>
                  ...
                  <input
                    ...
                    class="mt-1 block w-full max-w-xs rounded-lg border border-gray-300 bg-white px-3 py-2 shadow-sm focus:border-magenta-500 focus:outline-none focus:ring-2 focus:ring-magenta-500/20 dark:border-gray-500 dark:bg-gray-700 dark:text-white sm:text-sm"
                    max="365"
                    min="1"
                    placeholder="30"
                    type="number"
                ...
                <div>
                  ...
                  <textarea
                    ...
                    class="mt-1 block w-full rounded-lg border border-gray-300 bg-white px-3 py-2 shadow-sm focus:border-magenta-500 focus:outline-none focus:ring-2 focus:ring-magenta-500/20 dark:border-gray-500 dark:bg-gray-700 dark:text-white sm:text-sm"
              ...
              <div class="mt-4 rounded-lg bg-magenta-50 p-4 dark:bg-magenta-900/20">
                <div class="flex">
                  <i class="fas fa-lightbulb mt-0.5 text-magenta-500"></i>
                  <div class="ml-3">
                    <p class="text-sm text-magenta-700 dark:text-magenta-300">
                      <strong>工作原理：</strong>系统会提取请求中的原始 session ID （来自
                      <code class="rounded bg-magenta-100 px-1 dark:bg-magenta-800"
                        >metadata.user_id</code
                      >）， 并将其与首次调度的账户绑定。后续使用相同 session ID
                      的请求将自动路由到同一账户。
                    </p>
                    <p class="mt-2 text-sm text-magenta-700 dark:text-magenta-300">
            ...
            >
              <div class="flex items-center justify-between">
                <div class="flex items-center">
                  <div
                    class="flex h-12 w-12 items-center justify-center rounded-lg bg-gradient-to-r from-primary-500 to-accent-500 text-white shadow-lg"
                  >
              ...
              <div v-if="claudeConfig.concurrentRequestQueueEnabled" class="mt-6 space-y-4">
                ...
                <div>
                  ...
                  <input
                    ...
                    class="mt-1 block w-full max-w-xs rounded-lg border border-gray-300 bg-white px-3 py-2 shadow-sm focus:border-primary-500 focus:outline-none focus:ring-2 focus:ring-primary-500/20 dark:border-gray-500 dark:bg-gray-700 dark:text-white sm:text-sm"
                    max="100"
                    min="1"
                    placeholder="3"
                    type="number"
              ...
              <div class="mt-4 rounded-lg bg-primary-50 p-4 dark:bg-primary-900/20">
                <div class="flex">
                  <i class="fas fa-info-circle mt-0.5 text-primary-500"></i>
                  <div class="ml-3">
                    <p class="text-sm text-primary-700 dark:text-primary-300">
                      <strong>工作原理：</strong>当 API Key 的并发请求超过
                      <code class="rounded bg-primary-100 px-1 dark:bg-primary-800"
  ...
  >
    ...
    >
      <!-- 头部 -->
      <div
        class="dark:to-gray-750 relative border-b border-gray-200 bg-gradient-to-r from-primary-50 to-secondary-50 px-6 py-5 dark:border-gray-700 dark:from-gray-800"
      >
        <div class="flex items-center justify-between">
          <div class="flex items-center space-x-3">
            <div
              class="flex h-10 w-10 items-center justify-center rounded-full bg-gradient-to-br from-primary-500 to-secondary-600 text-white shadow-lg"
            >
        ...
        <div class="space-y-5">
          ...
          <div>
            ...
            <div class="relative">
              <select
                ...
                class="w-full appearance-none rounded-xl border border-gray-300 bg-white px-4 py-3 pr-10 text-gray-900 shadow-sm transition-all focus:border-primary-500 focus:outline-none focus:ring-2 focus:ring-primary-500/20 dark:border-gray-600 dark:bg-gray-700 dark:text-white"
          ...
          <div>
            ...
            <input
              ...
              class="w-full rounded-xl border border-gray-300 bg-white px-4 py-3 text-gray-900 shadow-sm transition-all placeholder:text-gray-400 focus:border-primary-500 focus:outline-none focus:ring-2 focus:ring-primary-500/20 dark:border-gray-600 dark:bg-gray-700 dark:text-white dark:placeholder:text-gray-500"
          ...
          >
            ...
            <div class="relative">
              <input
                ...
                class="w-full rounded-xl border border-gray-300 bg-white px-4 py-3 pr-10 font-mono text-sm text-gray-900 shadow-sm transition-all placeholder:text-gray-400 focus:border-primary-500 focus:outline-none focus:ring-2 focus:ring-primary-500/20 dark:border-gray-600 dark:bg-gray-700 dark:text-white dark:placeholder:text-gray-500"
                :class="{
            ...
            <div
              ...
              class="mt-2 flex items-start rounded-lg bg-primary-50 p-3 dark:bg-primary-900/20"
            >
              <i class="fas fa-info-circle mr-2 mt-0.5 text-primary-600 dark:text-primary-400"></i>
              <p class="text-sm text-primary-700 dark:text-primary-300">
          ...
          <div v-if="platformForm.type === 'telegram'" class="space-y-5">
            ...
            <div
              class="flex items-start rounded-lg bg-primary-50 p-3 text-sm text-primary-700 dark:bg-primary-900/20 dark:text-primary-300"
            >
          ...
          <div v-if="platformForm.type === 'bark'" class="space-y-5">
            ...
            <!-- 提示信息 -->
            <div class="mt-2 flex items-start rounded-lg bg-primary-50 p-3 dark:bg-primary-900/20">
              <i class="fas fa-info-circle mr-2 mt-0.5 text-primary-600 dark:text-primary-400"></i>
            ...
            <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
              <div>
                ...
                <input
                  ...
                  class="w-full rounded-xl border border-gray-300 bg-white px-4 py-3 text-gray-900 shadow-sm transition-all focus:border-primary-500 focus:outline-none focus:ring-2 focus:ring-primary-500/20 dark:border-gray-600 dark:bg-gray-700 dark:text-white"
                  max="65535"
                  min="1"
                  placeholder="587"
                  type="number"
              ...
              <div class="flex items-center justify-between">
                <label class="flex cursor-pointer items-center" for="enableSign">
                  <input
                    ...
                    class="h-4 w-4 rounded border-gray-300 text-primary-600 focus:ring-2 focus:ring-primary-500 focus:ring-offset-0"
                    type="checkbox"
                  />
                  <span
              ...
              >
                <div v-if="platformForm.enableSign">
                  ...
                  <input
                    ...
                    class="w-full rounded-xl border border-gray-300 bg-white px-4 py-3 font-mono text-sm text-gray-900 shadow-sm transition-all placeholder:text-gray-400 focus:border-primary-500 focus:outline-none focus:ring-2 focus:ring-primary-500/20 dark:border-gray-600 dark:bg-gray-800 dark:text-white dark:placeholder:text-gray-500"
                    placeholder="SEC..."
                    type="text"
                  />
                </div>
      ...
      >
        <div class="flex items-center justify-between">
          ...
          <div class="flex space-x-3">
            ...
            <button
              class="group flex items-center rounded-xl border border-primary-200 bg-primary-50 px-4 py-2.5 text-sm font-medium text-primary-700 shadow-sm transition-all hover:bg-primary-100 hover:shadow-md dark:border-primary-800 dark:bg-primary-900/50 dark:text-primary-300 dark:hover:bg-primary-900/70"
            ...
            <button
              class="group flex items-center rounded-xl bg-gradient-to-r from-primary-600 to-secondary-600 px-5 py-2.5 text-sm font-medium text-white shadow-md transition-all hover:from-primary-700 hover:to-secondary-700 hover:shadow-lg disabled:cursor-not-allowed disabled:from-gray-400 disabled:to-gray-500"
...
const getPlatformIcon = (type) => {
  const icons = {
    ...
    dingtalk: 'fas fa-comment-dots text-primary-500',
    feishu: 'fas fa-dove text-primary-600',
    slack: 'fab fa-slack text-magenta-600',
    discord: 'fab fa-discord text-secondary-600',
    telegram: 'fab fa-telegram-plane text-sky-500',
    bark: 'fas fa-bell text-orange-500',
    smtp: 'fas fa-envelope text-primary-600',
...
.form-input {
  @apply w-full rounded-lg border border-gray-300 px-4 py-2 transition-all duration-200 focus:border-transparent focus:ring-2 focus:ring-primary-500;
}
