  ...
  <div class="card p-3 sm:p-6">
        ...
        <button
          ...
          :class="[
            ...
            activeTutorialSystem === system.key
              ? 'bg-white text-primary-600 shadow-sm dark:bg-primary-600 dark:text-white dark:shadow-primary-500/40'
    ...
    <div v-if="activeTutorialSystem === 'windows'" class="tutorial-content">
      ...
      <div class="mb-4 sm:mb-10 sm:mb-6">
        ...
        >
          <span
            class="mr-2 flex h-6 w-6 items-center justify-center rounded-full bg-primary-500 text-xs font-bold text-white sm:mr-3 sm:h-8 sm:w-8 sm:text-sm"
            >1</span
          >
          安装 Node.js 环境
        </h4>
        ...
        <div
          class="mb-4 rounded-xl border border-primary-100 bg-gradient-to-r from-primary-50 to-secondary-50 p-4 dark:border-primary-500/40 dark:from-primary-950/30 dark:to-secondary-950/30 sm:mb-4 sm:mb-6 sm:p-6"
        >
          <h5
            class="mb-2 flex items-center text-base font-semibold text-gray-800 dark:text-gray-200 sm:mb-3 sm:text-lg"
          >
            <i class="fab fa-windows mr-2 text-primary-600" />
            Windows 安装方法
          </h5>
          ...
          <div
            class="rounded-lg border border-primary-200 bg-primary-50 p-3 dark:border-primary-500/40 dark:bg-primary-950/30 sm:p-4"
          >
            <h6
              class="mb-2 text-sm font-medium text-primary-800 dark:text-primary-300 sm:text-base"
            >
              Windows 注意事项
            </h6>
            <ul
              class="space-y-1 text-xs text-primary-700 dark:text-primary-300 sm:text-sm sm:text-xs"
            >
      ...
      <div class="mb-4 sm:mb-10 sm:mb-6">
        ...
        >
          ...
          <div
            class="mt-4 rounded-lg border border-primary-200 bg-primary-50 p-3 dark:border-primary-500/40 dark:bg-primary-950/30 sm:p-4"
          >
            <h6
              class="mb-2 text-sm font-medium text-primary-800 dark:text-primary-300 sm:text-base"
            >
            ...
            <ul class="space-y-1 text-xs text-primary-700 dark:text-primary-300 sm:text-sm">
      ...
      <div class="mb-6 sm:mb-10">
        ...
        >
          <span
            class="mr-2 flex h-6 w-6 items-center justify-center rounded-full bg-magenta-500 text-xs font-bold text-white sm:mr-3 sm:h-8 sm:w-8 sm:text-sm"
            >3</span
          >
          设置环境变量
        </h4>
        ...
        <div
          class="mb-4 rounded-xl border border-magenta-100 bg-gradient-to-r from-magenta-50 to-secondary-50 p-4 dark:border-magenta-500/40 dark:from-magenta-950/30 dark:to-secondary-950/30 sm:mb-6 sm:p-6"
        >
          <h5
            class="mb-2 flex items-center text-base font-semibold text-gray-800 dark:text-gray-200 sm:mb-3 sm:text-lg"
          >
            <i class="fas fa-cog mr-2 text-magenta-600" />
            配置 Claude Code 环境变量
          </h5>
          <p class="mb-3 text-sm text-gray-700 dark:text-gray-300 sm:mb-4 sm:text-base">
          ...
          <div class="space-y-4">
            <div
              class="rounded-lg border border-magenta-200 bg-white p-3 dark:border-magenta-700 dark:bg-gray-800 sm:p-4"
            >
        ...
        <!-- VSCode 插件配置 -->
        <div
          class="mt-6 rounded-lg border border-secondary-200 bg-secondary-50 p-3 dark:border-secondary-500/40 dark:bg-secondary-950/30 sm:p-4"
        >
          <h6 class="mb-2 font-medium text-secondary-800 dark:text-secondary-300">
            VSCode Claude 插件配置
          </h6>
          <p class="mb-3 text-sm text-secondary-700 dark:text-secondary-300">
            如果使用 VSCode 的 Claude 插件，需要在配置文件中进行设置：
          </p>
          <div class="mb-3 space-y-2">
            <p class="text-sm text-secondary-700 dark:text-secondary-300">
              <strong>配置文件位置：</strong>
              <code class="rounded bg-secondary-100 px-1 dark:bg-secondary-900"
        ...
        <!-- 验证环境变量设置 -->
        <div
          class="mt-6 rounded-lg border border-primary-200 bg-primary-50 p-3 dark:border-primary-500/40 dark:bg-primary-950/30 sm:p-4"
        >
          <h6 class="mb-2 font-medium text-primary-800 dark:text-primary-300">验证环境变量设置</h6>
        ...
        <div class="mt-8">
          <h5
            class="mb-2 flex items-center text-base font-semibold text-gray-800 dark:text-gray-200 sm:mb-3 sm:text-lg"
          >
            <i class="fas fa-code mr-2 text-secondary-600" />
            配置 Codex 环境变量
          </h5>
          <p class="mb-3 text-sm text-gray-700 dark:text-gray-300 sm:mb-4 sm:text-base">
      ...
      <div class="mt-8">
        <h5
          class="mb-2 flex items-center text-base font-semibold text-gray-800 dark:text-gray-200 sm:mb-3 sm:text-lg"
        >
          <i class="fas fa-terminal mr-2 text-primary-600" />
          配置 Droid CLI
        </h5>
        <p class="mb-3 text-sm text-gray-700 dark:text-gray-300 sm:mb-4 sm:text-base">
          Droid CLI 使用
        ...
        <div
          class="rounded-lg border border-primary-200 bg-primary-50 p-3 dark:border-primary-500/40 dark:bg-primary-950/30 sm:p-4"
        >
          <h6 class="mb-2 text-sm font-medium text-primary-800 dark:text-primary-200 sm:text-base">
            配置文件示例
          </h6>
          <p class="mb-3 text-sm text-primary-700 dark:text-primary-200">
          ...
          <p class="mt-3 text-xs text-primary-700 dark:text-primary-200 sm:text-sm">
      ...
      <div class="mb-6 sm:mb-10">
        ...
        >
          <h5
            class="mb-2 flex items-center text-base font-semibold text-gray-800 dark:text-gray-200 sm:mb-3 sm:text-lg"
          >
            <i class="fas fa-download mr-2 text-magenta-600" />
            安装 Claude Code
          </h5>
          <p class="mb-3 text-sm text-gray-700 dark:text-gray-300 sm:mb-4 sm:text-base">
            打开 Terminal，运行以下命令：
    ...
    <div v-else-if="activeTutorialSystem === 'linux'" class="tutorial-content">
      ...
      <div class="mb-6 sm:mb-10">
        ...
        <div class="mt-8">
          ...
          >
            <h6
              class="mb-2 text-sm font-medium text-primary-800 dark:text-primary-200 sm:text-base"
            >
              配置文件示例
            </h6>
            <p class="mb-3 text-sm text-primary-700 dark:text-primary-200">
      ...
      <!-- 结尾 -->
      <div
        class="rounded-xl bg-gradient-to-r from-primary-500 to-magenta-600 p-4 text-center text-white sm:p-6"
      >
        <h5 class="mb-2 text-lg font-semibold sm:text-xl">🎉 恭喜你！</h5>
        <p class="mb-3 text-sm text-white/85 sm:mb-4 sm:text-base">
...
/* 注意事项框 - 主色系 */
html.dark :deep(.border-primary-200) {
  border-color: rgb(var(--primary-rgb) / 0.5) !important;
}

html.dark :deep(.bg-primary-50) {
  background-color: rgb(var(--primary-rgb) / 0.14) !important;
...
/* Secondary 提示框 */
html.dark :deep(.border-secondary-200) {
  border-color: rgb(var(--secondary-rgb) / 0.5) !important;
}

html.dark :deep(.bg-secondary-50) {
  background-color: rgb(var(--secondary-rgb) / 0.14) !important;
  border: 1px solid rgb(var(--secondary-rgb) / 0.3);
}

/* Magenta 提示框 */
html.dark :deep(.border-magenta-200) {
  border-color: rgb(var(--accent2-rgb) / 0.5) !important;
}

/* 渐变背景优化 */
html.dark :deep(.from-magenta-50) {
  background: linear-gradient(
    to right,
    rgb(var(--accent2-rgb) / 0.14),
    rgb(var(--secondary-rgb) / 0.14)
  ) !important;
  border: 1px solid rgb(var(--accent2-rgb) / 0.3);
}

html.dark :deep(.from-primary-50) {
  background: linear-gradient(
    to right,
...
/* 彩色文字优化 - 提高亮度 */
html.dark :deep(.text-primary-600),
html.dark :deep(.text-primary-700) {
  color: color-mix(in srgb, rgb(var(--primary-rgb)) 65%, white) !important;
}

html.dark :deep(.text-primary-800) {
  color: color-mix(in srgb, rgb(var(--primary-rgb)) 78%, white) !important;
}
...
html.dark :deep(.text-secondary-700) {
  color: color-mix(in srgb, rgb(var(--secondary-rgb)) 65%, white) !important;
}

html.dark :deep(.text-secondary-800) {
  color: color-mix(in srgb, rgb(var(--secondary-rgb)) 78%, white) !important;
}
...
html.dark :deep(.bg-secondary-100) {
  background-color: rgb(var(--secondary-rgb) / 0.2) !important;
}
...
/* 边框颜色统一优化 */
html.dark :deep(.border-magenta-700) {
  border-color: rgb(var(--accent2-rgb) / 0.6) !important;
}

html.dark :deep(.border-primary-100) {
  border-color: rgb(var(--primary-rgb) / 0.4) !important;
}
...
html.dark :deep(.border-magenta-100) {
  border-color: rgb(var(--accent2-rgb) / 0.4) !important;
}
