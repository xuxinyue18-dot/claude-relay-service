  ...
  <div class="flex min-h-screen items-center justify-center p-4 sm:p-6">
    ...
    >
      <div class="mb-6 text-center sm:mb-8">
        ...
        <div
          class="mx-auto mb-4 flex h-16 w-16 items-center justify-center overflow-hidden rounded-xl border backdrop-blur-sm sm:mb-6 sm:h-20 sm:w-20 sm:rounded-2xl"
          :style="{
            borderColor: 'var(--border-color)',
            background:
              'linear-gradient(135deg, var(--glow-primary) 0%, var(--glow-secondary) 100%)'
          }"
        >
        ...
        <template v-if="!oemLoading && authStore.oemSettings.siteName">
          <h1
            class="header-title mb-2 text-2xl font-bold text-gray-900 dark:text-gray-100 sm:text-3xl"
          >
