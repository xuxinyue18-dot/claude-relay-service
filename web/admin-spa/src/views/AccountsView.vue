    ...
    <div class="card p-4 sm:p-6">
      <div class="mb-4 flex flex-col gap-4 sm:mb-6">
        <SectionHeader
          ...
          subtitle="管理 Claude、Gemini、OpenAI 等账户与代理配置"
          title="账户管理"
          variant="primary"
        />
        <div class="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
          ...
          <div class="flex flex-col gap-3 sm:flex-row sm:flex-wrap sm:items-center sm:gap-3">
            ...
            <div class="group relative min-w-[160px]">
              <div
                class="absolute -inset-0.5 rounded-lg bg-gradient-to-r from-secondary-500 to-primary-500 opacity-0 blur transition duration-300 group-hover:opacity-20"
              ></div>
              <CustomDropdown
            ...
            <div class="group relative min-w-[140px]">
              <div
                class="absolute -inset-0.5 rounded-lg bg-gradient-to-r from-primary-500 to-secondary-500 opacity-0 blur transition duration-300 group-hover:opacity-20"
              ></div>
              <CustomDropdown
            ...
            <div class="group relative min-w-[160px]">
              <div
                class="absolute -inset-0.5 rounded-lg bg-gradient-to-r from-magenta-500 to-secondary-500 opacity-0 blur transition duration-300 group-hover:opacity-20"
              ></div>
              <CustomDropdown
                v-model="groupFilter"
                icon="fa-layer-group"
                icon-color="text-magenta-500"
          ...
          <div class="flex w-full flex-col gap-3 sm:w-auto sm:flex-row sm:items-center sm:gap-3">
            ...
            <div class="relative">
              <el-tooltip content="查看账户统计汇总" effect="dark" placement="bottom">
                ...
                >
                  <div
                    class="absolute -inset-0.5 rounded-lg bg-gradient-to-r from-secondary-500 to-magenta-500 opacity-0 blur transition duration-300 group-hover:opacity-20"
                  ></div>
                  <i class="fas fa-chart-bar relative text-secondary-500" />
                        ...
                        >
                          <div class="space-y-2">
                            ...
                            <div class="space-y-1 pt-1 text-gray-200 dark:text-gray-600">
                              <div class="flex items-center gap-2">
                                <div
                                  class="h-2 w-16 rounded bg-gradient-to-r from-primary-500 to-secondary-600"
                                ></div>
                          ...
                          <div class="space-y-2">
                            ...
                            <div class="space-y-1 text-gray-200 dark:text-gray-600">
                              <div class="flex items-start gap-2">
                                <i class="fas fa-clock mt-[2px] text-[10px] text-primary-500"></i>
                                <span class="font-medium text-white dark:text-gray-900"
                              ...
                              <div class="flex items-start gap-2">
                                <i
                                  class="fas fa-info-circle mt-[2px] text-[10px] text-secondary-500"
                                ></i>
                                <span class="font-medium text-white dark:text-gray-900"
                          ...
                          <div class="space-y-2">
                            ...
                            <div class="space-y-1 text-gray-200 dark:text-gray-600">
                              <div class="flex items-start gap-2">
                                <i class="fas fa-clock mt-[2px] text-[10px] text-secondary-500"></i>
                                <span class="font-medium text-white dark:text-gray-900"
                              ...
                              <div class="flex items-start gap-2">
                                <i class="fas fa-gem mt-[2px] text-[10px] text-magenta-500"></i>
                                <span class="font-medium text-white dark:text-gray-900"
                              ...
                              <div class="flex items-start gap-2">
                                <i
                                  class="fas fa-sync-alt mt-[2px] text-[10px] text-primary-500"
                                ></i>
                                <span class="font-medium text-white dark:text-gray-900"
                                  >到达重置时间后自动归零。</span
                                >
              ...
              <tr v-for="account in paginatedAccounts" :key="account.id" class="table-row">
                  ...
                  <div class="flex items-center">
                    ...
                    <div class="min-w-0">
                      <div class="flex items-center gap-2">
                        ...
                        <Badge v-if="account.accountType === 'dedicated'" variant="magenta">
                          <i class="fas fa-lock mr-1" />专属
                        </Badge>
                        <Badge v-else-if="account.accountType === 'group'" variant="primary">
                ...
                <td class="px-3 py-4">
                  <div class="flex items-center gap-1">
                    <!-- 平台图标和名称 -->
                    <Badge v-if="account.platform === 'gemini'" size="md" variant="warning">
                      <i class="fas fa-robot" />
                      <span>Gemini · {{ getGeminiAuthType() }}</span>
                    </Badge>
                    <Badge
                    ...
                    <Badge v-else-if="account.platform === 'bedrock'" size="md" variant="warning">
                      <i class="fab fa-aws" />
                      <span>Bedrock · AWS</span>
                    </Badge>
                    <Badge v-else-if="account.platform === 'openai'" size="md" variant="primary">
                      <span class="fa-openai" />
                      <span>OpenAI · {{ getOpenAIAuthType() }}</span>
                    </Badge>
                    <Badge
                    ...
                    >
                      ...
                      <span
                        ...
                        {{ getClaudeAuthType(account) }}</span
                      >
                    </Badge>
                    <Badge v-else-if="account.platform === 'ccr'" size="md" variant="accent">
                      <i class="fas fa-code-branch" />
                      <span>CCR · Relay</span>
                    </Badge>
                    <Badge v-else-if="account.platform === 'droid'" size="md" variant="accent">
                      <i class="fas fa-robot" />
                      <span>Droid · {{ getDroidAuthType(account) }}</span>
                      <span
                    ...
                    >
                      <i class="fas fa-robot" />
                      <span>Gemini-API · API Key</span>
                    </Badge>
                    <Badge v-else size="md" variant="neutral">
                ...
                <td class="w-[100px] min-w-[100px] max-w-[100px] whitespace-nowrap px-3 py-4">
                  <div class="flex flex-col gap-1">
                    <Badge :variant="getAccountStatusVariant(account)">
                      <i class="mr-1" :class="getAccountStatusIcon(account)" />
                    ...
                    >
                      ...
                      剩余 {{ formatRateLimitTime(account.rateLimitStatus.minutesRemaining) }}
                    </Badge>
                    <Badge v-if="account.schedulable === false" variant="neutral">
                ...
                <td class="whitespace-nowrap px-3 py-4 text-sm">
                  <div v-if="account.usage && account.usage.daily" class="space-y-1">
                    ...
                    <div class="flex items-center gap-2">
                      <div class="h-2 w-2 rounded-full bg-magenta-500" />
                  ...
                  <div class="mt-1 text-xs">
                    <button
                      v-if="
                        !(account.platform === 'gemini' && account.oauthProvider === 'antigravity')
                      "
                      class="text-primary-500 hover:underline dark:text-primary-300"
                  ...
                  <div v-if="account.platform === 'claude'" class="space-y-2">
                    ...
                    <div v-if="isClaudeOAuth(account) && account.claudeUsage" class="space-y-2">
                      ...
                      <div class="rounded-lg bg-gray-50 p-2 dark:bg-gray-700/70">
                        <div class="flex items-center gap-2">
                          <span
                            class="inline-flex min-w-[32px] justify-center rounded-full bg-secondary-100 px-2 py-0.5 text-[11px] font-medium text-secondary-600 dark:bg-secondary-500/20 dark:text-secondary-300"
                          >
                            5h
                          </span>
                          <div class="flex-1">
                      ...
                      <div class="rounded-lg bg-gray-50 p-2 dark:bg-gray-700/70">
                        <div class="flex items-center gap-2">
                          <span
                            class="inline-flex min-w-[32px] justify-center rounded-full bg-magenta-100 px-2 py-0.5 text-[11px] font-medium text-magenta-600 dark:bg-magenta-500/20 dark:text-magenta-300"
                          >
                            sonnet
                          </span>
                          <div class="flex-1">
                    ...
                    >
                      ...
                      >
                        <div class="flex items-center gap-1">
                          <div class="h-1.5 w-1.5 rounded-full bg-magenta-500" />
                      ...
                      <div class="text-xs text-gray-600 dark:text-gray-400">
                        ...
                        <div
                          ...
                          class="font-medium text-secondary-600 dark:text-secondary-400"
                        >
                  ...
                  <div v-else-if="account.platform === 'openai'" class="space-y-2">
                    <div v-if="account.codexUsage" class="space-y-2">
                      ...
                      <div class="rounded-lg bg-gray-50 p-2 dark:bg-gray-700/70">
                        <div class="flex items-center gap-2">
                          <span
                            class="inline-flex min-w-[32px] justify-center rounded-full bg-primary-100 px-2 py-0.5 text-[11px] font-medium text-primary-600 dark:bg-primary-500/20 dark:text-primary-300"
                          >
                ...
                <td class="whitespace-nowrap px-3 py-4">
                  ...
                  >
                    <div class="h-2 w-16 rounded-full bg-gray-200">
                      <div
                        class="h-2 rounded-full bg-gradient-to-r from-green-500 to-primary-600 transition-all duration-300"
                ...
                <td class="px-3 py-4 text-sm text-gray-600">
                  <div
                    ...
                    class="break-all rounded bg-primary-50 px-2 py-1 font-mono text-xs"
                ...
                >
                  ...
                  <div v-if="!needsHorizontalScroll" class="flex items-center gap-1">
                    ...
                    <button
                      ...
                      class="rounded bg-secondary-100 px-2.5 py-1 text-xs font-medium text-secondary-700 transition-colors hover:bg-secondary-200"
                      title="查看使用详情"
                    ...
                    <button
                      class="rounded bg-primary-100 px-2.5 py-1 text-xs font-medium text-primary-700 transition-colors hover:bg-primary-200"
                      title="编辑账户"
      ...
      <div v-if="!accountsLoading && sortedAccounts.length > 0" class="space-y-3 md:hidden">
        ...
        >
            ...
            <div class="flex items-center gap-3">
              ...
              <div
                :class="[
                  ...
                  account.platform === 'claude'
                    ? 'bg-gradient-to-br from-magenta-500 to-magenta-600'
                    : account.platform === 'bedrock'
          ...
          <div class="mt-3 flex gap-2 border-t border-gray-100 pt-3">
            ...
            <button
              v-if="canViewUsage(account)"
              class="flex flex-1 items-center justify-center gap-1 rounded-lg bg-secondary-50 px-3 py-2 text-xs text-secondary-600 transition-colors hover:bg-secondary-100"
              @click="openAccountUsageModal(account)"
            >
              <i class="fas fa-chart-line" />
              详情
    ...
    >
      <div class="flex w-full flex-col items-center gap-3 sm:w-auto sm:flex-row">
        ...
        <div class="flex items-center gap-2">
          ...
          <select
            v-model="pageSize"
            class="rounded-md border border-gray-200 bg-white px-2 py-1 text-xs text-gray-700 transition-colors hover:border-gray-300 focus:border-transparent focus:outline-none focus:ring-2 focus:ring-primary-500 dark:border-gray-600 dark:bg-gray-800 dark:text-gray-300 dark:hover:border-gray-500 sm:text-sm"
          ...
          <table class="w-full border-collapse text-sm" style="min-width: 1000px">
            <thead class="bg-gray-100 dark:bg-gray-700">
              <tr>
                ...
                <th
                  class="border border-gray-300 bg-primary-50 px-4 py-2 text-center font-bold dark:border-gray-600 dark:bg-primary-900/30"
                >
                  合计
                </th>
              </tr>
            ...
            <tbody>
              ...
              <tr class="bg-primary-50 font-bold dark:bg-primary-900/30">
...
const getAccountStatusVariant = (account) => {
  if (account.status === 'blocked') return 'danger'
  if (account.status === 'unauthorized') return 'danger'
  if (
    account.isRateLimited ||
    account.status === 'rate_limited' ||
    (account.rateLimitStatus && account.rateLimitStatus.isRateLimited) ||
    ...
    return 'warning'
  if (account.status === 'temp_error') return 'warning'
  if (account.status === 'error' || !account.isActive) return 'danger'
  if (account.schedulable === false) return 'neutral'
  return 'success'
}

const getAccountStatusIcon = (account) => {
  if (account.status === 'blocked') return 'fas fa-ban'
  if (account.status === 'unauthorized') return 'fas fa-exclamation-triangle'
  if (
    account.isRateLimited ||
    account.status === 'rate_limited' ||
    (account.rateLimitStatus && account.rateLimitStatus.isRateLimited) ||
  ...
  if (account.status === 'temp_error') return 'fas fa-clock'
  if (account.status === 'error' || !account.isActive) return 'fas fa-times-circle'
  if (account.schedulable === false) return 'fas fa-pause-circle'
...
const getSessionProgressBarClass = (status, account = null) => {
  ...
  if (!status) {
    // 无状态信息时默认为蓝色
    return 'bg-gradient-to-r from-primary-500 to-secondary-600'
  }
